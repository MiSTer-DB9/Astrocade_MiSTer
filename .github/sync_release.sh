...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Astrocade_MiSTer.git"
CORE_NAME=(Astrocade)
...
UPSTREAM_CORE_NAME=(Astrocade)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Astrocade.qpf)
COMPILATION_OUTPUT=(output_files/Astrocade.rbf)
